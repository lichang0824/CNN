#!/bin/bash
# Job name:
#SBATCH --job-name=CNN_3_ReLU_15_0.0001_4
#
# Account:
...
python3 ./U-Net/Savio_3D_CNN.py --kernel_size 3 --activation_fn ReLU --epochs_choice 15 --learning_rate 0.0001 --batch_size 4